use super::osm_way_ops::{self, serialize_linestring,deserialize_linestring};
...
pub struct OsmWayDataSerializable {
    ...
    #[serde(serialize_with = "serialize_linestring", deserialize_with="deserialize_linestring")]
